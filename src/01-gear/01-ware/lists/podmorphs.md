# Augmentations for Biomorphs and Podmorphs with a cyberbrain
...
| Drone Rig                         |     CM    |    Mod/2              | Ignore the −10 modifier when jamming.                                                                     |     Comms     |
...
| Energy Efficiency                 |    BM     |    Maj/3              | One extra short recharge per day.                                                                         |               |
...
| Hypermesh Link                    |     CM    |   Maj/3/R             | Group mind-state, +1 Insight, can use Insight to borrow skills.                                           |               |
...
| Memory Lock                       |    CM     |    Min/1              | Blocks memory retention/recording when activated.                                                         |               |
| Mesh Inserts                      |    C      |    Min/1              | Cranial computer, wireless transceiver, muse home, and medical sensors.                                   |     Comms     |
| Mimicry Module                    |    CM     |    Mod/2              | +10 Deceive, +30 impersonating specific target after test.                                                |               |
| Mind Amp                          |     MN    |    Maj/3              | Accelerates mind. +2 Insight.                                                                             |               |
| Mnemonics                         |    CM     |    Min/1              | Enhanced memory; +20 memory-related COG checks.                                                           |               |
| Multi-Ego Controls                |     M     |    Maj/3              | Multiple egos may control the same morph simultaneously.                                                  |               |
| Multi-Focus                       |    CM     |    Min/1              | Focus on 1 additional thing at once or maintain ongoing mental task. Requires multi-tasking.              |               |
| Multi-Tasking                     |    CM     |    Mod/2              | Focus on 2 things at once. +1 Insight.                                                                    |               |
...
| Oracles                           |    CM     |    Mod/2              | +10 Perceive, negate distraction modifiers.                                                               |    Senses     |
...
| Polarization Vision               |    BC     |    Min/1              | See polarized light, ignore camo modifiers.                                                               |    Senses     |
...
| Skillware                         |    CM     |    Maj/3              | Can use 120 points of skillsofts.                                                                         |               |
...
| Wings                             |    BC     |    Mod/2              | Enable flight if small or in low gravities. Movement Rate Winged 8/32 (medium) or 8/40 (small).           |   Mobility    |
