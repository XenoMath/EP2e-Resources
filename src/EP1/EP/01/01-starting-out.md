...
- [**A Time of Eclipse**](../02/00-time-eclipse.md):
    A comprehensive history and setting fully describes the *Eclipse Phase*
    universe and how humanity transitioned from here to there.
- [**Game Mechanics**](../03/00-game-mechanics.md):
    The player’s desired actions become reality within the universe
    through quick and easy-to-use game mechanics.
- [**Character Creation and Advancement**](../04/00-character-creation-advancement.md):
    Creating a unique character can be one of the most enjoyable experiences
    of roleplaying. Even more rewarding is watching that character evolve
    and grow across numerous gaming sessions, far beyond anything
    your imagination first envisioned.
- [**Skills**](../05/00-skills.md):
...
- [**Action and Combat**](../06/00-action-combat.md):
    What is a dramatic story without action and violence?
    When words fail, weapons will blaze.
- [**Mind Hacks**](../07/00-mind-hacks.md): 
    The unusual possibilities offered by psi abilities
    and mental reprogramming.
- [**The Mesh**](../08/00-mesh.md): 
    The all-pervasive nature of the mesh
    ensures that it is a key element to any story.
- [**Accelerated Future**](../09/00-accelerated-future.md): 
